...
func assertNoField(t *testing.T, s, field, msg string) {
	t.Helper()
...
func TestAppendEntry_CreatesFile(t *testing.T) {
	...
	assertCreatedEntryFields(t, dir, path)
}

func assertCreatedEntryFields(t *testing.T, dir, path string) {
	t.Helper()
	...
	s := string(data)
	assertNoField(t, s, "worktree", "worktree=false should be omitted")
	assertNoField(t, s, "labels", "empty labels should be omitted")
	assertNoField(t, s, "icon", "empty icon should be omitted")
	assertNoField(t, s, "windows", "empty windows should be omitted")
}
